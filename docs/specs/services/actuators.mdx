...
export const specs_group_pillars = [
    { name: "Switch Low 1-N",         pillarType: "Boolean",  pillarDir: "Action",  descr: "Multiple binary actuators for low consumption services like relays (true is on, false is off)."},
    ...
    { name: "Switch High 1-N",        pillarType: "Boolean",  pillarDir: "Action",  descr: "Multiple binary actuators for high consumption services like relays (true is on, false is off)."},
    ...
    { name: "Dimmer Low 1-N",         pillarType: "Range",   pillarDir: "Action",  descr: "Multiple dimmerable (0-100%) for low consumption services actuators like dimmers",
    ...
    { name: "Dimmer Low Max Current", pillarType: "Range",   pillarDir: "State",   descr: "Maximum current supported by low consumption Dimmer, in Amperes",
      min: "0",     max: "100",   step: "1",      unit: "Ampere"},
    { name: "Dimmer High 1-N",         pillarType: "Range",  pillarDir: "Action",  descr: "Multiple dimmerable (0-100%) for high consumption services actuators like dimmers",
      min: "0",     max: "100",   step: "10",     unit: "Percent"},
