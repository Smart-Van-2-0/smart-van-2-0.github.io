...
<SoftwareHeader
  ...
  url_logo="/img/software/jod_smart_van_image/jod_smart_van_image_logo_200.png" >

This image represent the firmware to flash on the main Raspberry into the IoT Box.
It a minimal RaspbianOS distribution plus the [JOD Smart Van Distribution](/docs/software/jod_smart_van/jod_smart_van).
