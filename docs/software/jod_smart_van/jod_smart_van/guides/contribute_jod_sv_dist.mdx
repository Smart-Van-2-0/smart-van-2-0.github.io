---
title: Contribute to JOD SV Dist.
hide_title: true
sidebar_position: 6
---
...
:::warning JOD 2.2.4 Required
This distribution requires some features available only on the 2.2.4
...
:::warning DBus system
If the remote machine does not have any graphical server installed, the DBUS
...
of [alternative `struct.jod` files](customize_svbox_structure#alternative-jod-structures) in the
