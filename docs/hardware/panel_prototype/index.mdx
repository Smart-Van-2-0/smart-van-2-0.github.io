...
and [case 3D models](/docs/hardware/panel_prototype/resources#cases--3d-models) to
...
2. <h3>Assemble the Smart Van Box's blocks and connect them</h3>
  Build each block following the [assembly guides](/docs/hardware/panel_prototype/guides#assembly-hardware).
