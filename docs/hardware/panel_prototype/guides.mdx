...
the [SV Mobile App](/docs/software/sv_mobile_app/android)** from your smart phone and
...
6. **Connect the SV Mobile App:**<br/>
  ...
  the [SV Mobile App](/docs/software/sv_mobile_app/android) on your smartphone and open
...
:::note
Always refer to the official JOD Smart Van and SV Mobile App
