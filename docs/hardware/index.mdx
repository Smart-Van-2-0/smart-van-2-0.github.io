...
<div style={div_style}>
  ...
  <Card sx={card_style}>
      <div style={text_style}>
        <h3>Your Prototype</h3>
        <p style={descr_style}>
          Help grow the community by sharing your SmartVan project!<br/>
          Every contribution is welcome. Simply send us the documentation for
          your project, and we'll assist in publishing it alongside other
          SmartVanBox models.

          <i>Email us at <a href="mailto:collaborate@smartvanbox.org">collaborate@smartvanbox.org</a></i>
        </p>
      </div>
  </Card>
