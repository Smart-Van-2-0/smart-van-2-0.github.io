...
<Button
  variant="contained"
  className={style_lnd.button_centered}><a href="https://www.kickstarter.com/projects/smartvanbox/smartvanbox" target="_blank">Go to<br/><b>Smart Van Campaign</b><br/>on Kickstarter</a></Button>
